...
namespace BuildExeBasic.Controllers
{
    ...
    [ApiController]
    public class GroupSubGroupLedgerController : ControllerBase
    {
        private readonly IGeneralLedgerRepository _generalLedgerRepository;
        private readonly IUserLogRepository _userLogRepository;
        private readonly IMdHashValidator _mdHashValidator;

        public GroupSubGroupLedgerController(IGeneralLedgerRepository generalLedgerRepository, IUserLogRepository userLogRepository, IMdHashValidator mdHashValidator)
        {
        ...
        public async Task<IActionResult> Post([FromBody] BasicSearch basicSearch, [FromHeader] string mdhash, [FromHeader] int User)
        {
                ...
                try
            {
                if (basicSearch != null)
                {
                    var product = await _generalLedgerRepository.GroupSubGroupLedger(basicSearch);
