...
namespace BuildExeBasic.Repository
{
    public class DocumentTypeRepository:IDocumentTypeRepository
    {
        ...
        public DocumentTypeRepository(BasicContext dbContext)
        {
        ...
        public async Task<IEnumerable<Validation>> Delete(int id,int userid)
        {
            try
            {
                ...
                return await _dbContext.tbl_validation.FromSqlRaw("StPro_DocumentType @id,@UserId,@json, @CompanyId, @BranchId, @Action", Id, UserId, json, CompanyId, BranchId, Action).ToListAsync();
            }
            catch (Exception ex)
            {
        ...
        public async Task<string>  GetByID(int id)
        {
            try
            {
                ...
                cmd.CommandText = "dbo.StPro_DocumentType";
        ...
        public async Task<IEnumerable<Validation>> Insert(DocumentType documentType)
        {
            try
            {
                var Id = new SqlParameter("@id", "0");
                var UserId = new SqlParameter("@UserId", "0");
                var json = new SqlParameter("@json", JsonConvert.SerializeObject(documentType));
                var CompanyId = new SqlParameter("@CompanyId", "0");
                var BranchId = new SqlParameter("@BranchId", "0");
        ...
        public async Task<IEnumerable<Validation>> Update(DocumentType documentType)
        {
            try
            {
                var Id = new SqlParameter("@id", "0");
        ...
        public async Task<IEnumerable<Validation>> CheckEditDelete(int id)
        {
            ...
            {
                var Id = new SqlParameter("@Id", id);
                var purchaseList = await _dbContext.tbl_validation.FromSqlRaw("Stpro_CheckDocTypeEditDelete @Id", Id).ToListAsync();
                return purchaseList;
            }
            catch (Exception ex)
            {
