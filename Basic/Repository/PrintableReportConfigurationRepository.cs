...
namespace BuildExeBasic.Repository
{
    public class PrintableReportConfigurationRepository : IPrintableReportConfigurationRepository
    {
        ...
        public async Task<string> StaticPrintableProformaInvoice(int BranchId, int ReportId, int RecordId)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                cmd.CommandText = "dbo.Stpro_StaticPrintableReportsInProformaInvoice";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@BranchId", SqlDbType.Int) { Value = BranchId });
                cmd.Parameters.Add(new SqlParameter("@ReportId", SqlDbType.Int) { Value = ReportId });
                cmd.Parameters.Add(new SqlParameter("@RecordId", SqlDbType.Int) { Value = RecordId });
        ...
        public async Task<string> StaticPrintableEstimation(int BranchId, int ReportId, int RecordId,int IsEnquiryWise)
        {
            ...
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                cmd.CommandText = "dbo.Stpro_StaticPrintableReportsInEstimation";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@BranchId", SqlDbType.Int) { Value = BranchId });
                cmd.Parameters.Add(new SqlParameter("@ReportId", SqlDbType.Int) { Value = ReportId });
                cmd.Parameters.Add(new SqlParameter("@RecordId", SqlDbType.Int) { Value = RecordId });
        ...
        public async Task<string> StaticPrintableInvoiceGeneration(int BranchId, int ReportId, int RecordId)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                cmd.CommandText = "dbo.Stpro_StaticPrintableReportsInInvoiceGeneration";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@BranchId", SqlDbType.Int) { Value = BranchId });
                cmd.Parameters.Add(new SqlParameter("@ReportId", SqlDbType.Int) { Value = ReportId });
                cmd.Parameters.Add(new SqlParameter("@RecordId", SqlDbType.Int) { Value = RecordId });
        ...
        public async Task<string> StaticPrintableDeliveryOrder(int BranchId, int ReportId, int RecordId)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                cmd.CommandText = "dbo.Stpro_StaticPrintableReportsInDeliveryOrder";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@BranchId", SqlDbType.Int) { Value = BranchId });
                cmd.Parameters.Add(new SqlParameter("@ReportId", SqlDbType.Int) { Value = ReportId });
                cmd.Parameters.Add(new SqlParameter("@RecordId", SqlDbType.Int) { Value = RecordId });
        ...
        public async Task<string> StaticPrintableSiteService(int BranchId, int ReportId, int RecordId)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
        ...
        public async Task<string> StaticPrintableServiceQuatation(int BranchId, int ReportId, int RecordId)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                cmd.CommandText = "dbo.Stpro_StaticPrintableReportsInServiceQuatation";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@BranchId", SqlDbType.Int) { Value = BranchId });
                cmd.Parameters.Add(new SqlParameter("@ReportId", SqlDbType.Int) { Value = ReportId });
                cmd.Parameters.Add(new SqlParameter("@RecordId", SqlDbType.Int) { Value = RecordId });
        ...
        public async Task<string> StaticPrintablePDI(int BranchId, int ReportId, int RecordId)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                cmd.CommandText = "dbo.Stpro_StaticPrintableReportsInPDI";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@BranchId", SqlDbType.Int) { Value = BranchId });
                cmd.Parameters.Add(new SqlParameter("@ReportId", SqlDbType.Int) { Value = ReportId });
                cmd.Parameters.Add(new SqlParameter("@RecordId", SqlDbType.Int) { Value = RecordId });
