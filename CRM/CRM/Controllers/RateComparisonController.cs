...
namespace BuildExeServices.Controllers
{
    ...
    [ApiController]
    public class RateComparisonController : ControllerBase
    {
        private readonly IProjectSpecificationRepository _projectSpecificationRepository;
        private readonly IUserLogRepository _userLogRepository;
        private readonly IMdHashValidator _mdHashValidator;

        public RateComparisonController(IProjectSpecificationRepository projectSpecificationRepository, IUserLogRepository userLogRepository, IMdHashValidator mdHashValidator)
        {
        ...
        public async Task <IActionResult> Put([FromBody] IEnumerable<ProjectSpecificationMaster> projectSpecificationMasters, [FromHeader] string mdhash, [FromHeader] int User)
        {
                ...
                if (projectSpecificationMasters != null)
            {
                ...
                {
                            var val = await _projectSpecificationRepository.approve (projectSpecificationMasters);
