...
{
    public class GroupLabourWagePayment
    {
        ...
        public List<GroupLabourWagePaymentDetails> GroupLabourWagePaymentDetails { get; set; }
        //public List<OtherChargeDetails> OtherChargeDetails { get; set; }
    }
    public class GroupLabourWagePaymentDetails
    {
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int GroupLabourWagePaymentDetailsId { get; set; }
        public int GroupLabourWagePaymentId { get; set; }
