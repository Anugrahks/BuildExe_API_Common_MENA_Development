...
{
    public class LeaveSurrenderMasterRepository : ILeaveSurrenderMasterRepository
    {
        private readonly HRContext _dbContext;
        public LeaveSurrenderMasterRepository(HRContext dbContext)
        {
        ...
        public async Task<IEnumerable<Validation>> Insert(IEnumerable<LeaveSurrenderMaster> specificationMasters)
        {
            try
            {
                ...
                return await _dbContext.tbl_validation.FromSqlRaw("Stpro_LeaveSurrenderMaster @Id,@item,@CompanyId,@BranchId,@userId,@Action", Id, item, CompanyId, BranchId, userId, Action).ToListAsync();
            }
            catch (Exception ex)
            {
        ...
        public async Task<IEnumerable<Validation>> Update(IEnumerable<LeaveSurrenderMaster> specificationMasters)
        {
            try
            {
                var Id = new SqlParameter("@Id", "0");
        ...
        public async Task<string> GetGrid(int BranchId, int FinancialYearId, int UserId)
        {
            try
            {
                ...
                cmd.CommandText = "dbo.Stpro_LeaveSurrenderMaster";
        ...
        public async Task<string> GetById(int Id, int CompanyId, int BranchId, int FinancialYearId)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
