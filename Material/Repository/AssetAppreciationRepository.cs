...
{
    public class AssetAppreciationRepository : IAssetAppreciationRepository
    {
        private readonly MaterialContext _dbContext;
        public AssetAppreciationRepository(MaterialContext dbContext)
        {
        ...
        public async Task<IEnumerable<Validation>> Insert(IEnumerable<AssetAppreciation> specificationMasters)
        {
            try
            {
                ...
                return await _dbContext.tbl_validation.FromSqlRaw("Stpro_AssetAppreciation @Id,@item,@CompanyId,@BranchId,@userId,@Action", Id, item, CompanyId, BranchId, userId, Action).ToListAsync();
            }
            catch (Exception ex)
            {
        ...
        public async Task<IEnumerable<Validation>> Update(IEnumerable<AssetAppreciation> specificationMasters)
        {
            try
            {
                var Id = new SqlParameter("@Id", "0");
        ...
        public async Task<string> GetGrid(int BranchId, int FinancialYearId, int UserId)
        {
            try
            {
                ...
                cmd.CommandText = "dbo.Stpro_AssetAppreciation";
