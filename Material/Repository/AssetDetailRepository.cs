...
namespace BuildExeMaterialServices.Repository
{
    public class AssetDetailRepository : IAssetDetailRepository
    {
        ...
        public AssetDetailRepository(MaterialContext dbContext)
        {
        ...
        public async Task<IEnumerable<Validation>> Insert(IEnumerable<AssetDetailEntryMaster> specificationMasters)
        {
            try
            {
                ...
                return await _dbContext.tbl_validation.FromSqlRaw("Stpro_AssetDetailEntry @Id,@item,@CompanyId,@BranchId,@userId,@Action", Id, item, CompanyId, BranchId, userId, Action).ToListAsync();
            }
            catch (Exception ex)
            {
        ...
        public async Task<IEnumerable<Validation>> Update(IEnumerable<AssetDetailEntryMaster> specificationMasters)
        {
            try
            {
                var Id = new SqlParameter("@Id", "0");
        ...
        public async Task<string> GetGrid(int BranchId , int FinancialYearId, int UserId)
        {
            try
            {
                ...
                cmd.CommandText = "dbo.Stpro_AssetDetailEntry";
        ...
        public async Task<string> GetApprovedData(int BranchId, int FinancialYearId, int UserId)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
        ...
        public async Task<string> GetPurchaseList(int BranchId)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
        ...
        public async Task<string> GetMaterialList(MaterialSearch materialSearch)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                ...
                cmd.Parameters.Add(new SqlParameter("@Id", SqlDbType.Int) { Value = 0 });
                cmd.Parameters.Add(new SqlParameter("@json", SqlDbType.NVarChar) { Value = materialSearch.PurchaseIds });
                cmd.Parameters.Add(new SqlParameter("@CompanyId", SqlDbType.Int) { Value = 0 });
                cmd.Parameters.Add(new SqlParameter("@BranchId", SqlDbType.Int) { Value = 0 });
                cmd.Parameters.Add(new SqlParameter("@UserId", SqlDbType.Int) { Value = 0 });
        ...
        public async Task<string> Material(MaterialSearch materialSearch)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();

                cmd.CommandText = "dbo.Stpro_BudgetedVsActual";
                cmd.CommandType = CommandType.StoredProcedure;




                cmd.Parameters.Add(new SqlParameter("@id", SqlDbType.Int) { Value = materialSearch.TypeId });
        ...
        public async Task<string> Report(MaterialSearch materialSearch)
        {
            try
            {
                DbCommand cmd = _dbContext.Database.GetDbConnection().CreateCommand();

                cmd.CommandText = "dbo.Stpro_BudgetedVsActualReport";
                cmd.CommandType = CommandType.StoredProcedure;
