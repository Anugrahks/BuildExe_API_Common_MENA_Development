...
namespace BuildExeMaterialServices.Repository
{
    public class DeliveryOrderRepository : IDeliveryOrderRepository
    {
        ...
        public DeliveryOrderRepository(MaterialContext dbContext)
        {
        ...
        //        cmd.Parameters.Add(new SqlParameter("@Id", SqlDbType.Int) { Value = IsAsset });
        //        cmd.Parameters.Add(new SqlParameter("@CompanyId", SqlDbType.Int) { Value = CompanyId });
        //        cmd.Parameters.Add(new SqlParameter("@BranchId", SqlDbType.Int) { Value = Branchid });
        //        cmd.Parameters.Add(new SqlParameter("@json", SqlDbType.NVarChar) { Value = "" });
        //        cmd.Parameters.Add(new SqlParameter("@FinancialYearId", SqlDbType.Int) { Value = FinancialYearId });
        ...
        //public async Task<string> GetApproval(int CompanyId, int Branchid, int UserId, int FinancialYearId, int IsAsset)
        //{
        //    try
        //    {
        //        using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
       ...
       public async Task<string> GetDeliveryOrderReport(MaterialSearch materialSearch)
        {
            try
            {
                ...
                cmd.CommandText = "dbo.stpro_DeliveryOrderReport";
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                {
                    orderItems += dataTable.Rows[i][0].ToString();
                }
                if (orderItems == "")
                    orderItems = "[]";
                return orderItems;
