...
namespace BuildExeServiceManagement.Repository
{
    public class PumpModuleRepository : IPumpModuleRepository
    {
        ...
        public async Task<string> GetPumbDetails(int CompanyId, int Branchid, int UserId, int FinancialYearId, int StockPointId)
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                ...
                cmd.Parameters.Add(new SqlParameter("@StockPointId", SqlDbType.Int) { Value = StockPointId });
                cmd.Parameters.Add(new SqlParameter("@CompanyId", SqlDbType.Int) { Value = CompanyId });
                cmd.Parameters.Add(new SqlParameter("@BranchId", SqlDbType.Int) { Value = Branchid });
                cmd.Parameters.Add(new SqlParameter("@FinancialYearId", SqlDbType.Int) { Value = FinancialYearId });
        ...
        public async Task<string> GetServiceLookUp(int CustomerId, int CompanyId, int BranchId)                      //added
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();

                cmd.CommandText = "dbo.Stpro_ServiceLookUp";
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public async Task<string> GetServiceQuotationAll(int CompanyId, int BranchId)      //added
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                ...
                cmd.Parameters.Add(new SqlParameter("@UserId", SqlDbType.NVarChar) { Value = DBNull.Value });
                cmd.Parameters.Add(new SqlParameter("@Json", SqlDbType.NVarChar) { Value = DBNull.Value });
                cmd.Parameters.Add(new SqlParameter("@Action", SqlDbType.Int) { Value = 20 });
        ...
        public async Task<string> GetServiceQuotationListings(int CompanyId, int BranchId, int FinancialYearId, int UserId)           //Added
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
        ...
        public async Task<string> GetPumpAutoFetch(int CompanyId, int BranchId)      
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
        ...
        public async Task<string> GetJobAutoFetch(int CompanyId, int BranchId)      
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
        ...
        public async Task<string> Getjob(int CustomerId, int CompanyId, int BranchId)     
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
                ...
                cmd.Parameters.Add(new SqlParameter("@Action", SqlDbType.Int) { Value = 21 });
        ...
        public async Task<string> Getjobconsuption(int CustomerId, int CompanyId, int BranchId)
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
