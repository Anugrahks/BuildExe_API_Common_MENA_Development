...
namespace BuildExeServiceManagement.Repository
{
    public class ServiceQuotationRepository : IServiceQuotationRepository
    {
        ...
        public async Task<string> GetData(int CompanyId, int Branchid, int UserId, int FinancialYearId, int CustomerId, int JobId, int Id)
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
        ...
        public async Task<string> GetforEditServiceuser(int companyId, int branchid, int UserId, int FinancialYearId)
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
        ...
        public async Task<string> GetforEditServiceuserApproval(int companyId, int branchid, int UserId, int FinancialYearId)
        {
            try
            {
                using var cmd = _dbContext.Database.GetDbConnection().CreateCommand();
